...
class ReviewSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        review = response.css('.a-expander-partial-collapse-content , .a-expander-partial-collapse-content .cr-original-review-content').css('::text').extract()
        votes = response.css('.cr-vote-text::text').extract()

        # comments = response.css('').extract()
        #-------------------------------
