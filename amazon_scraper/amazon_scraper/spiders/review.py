...
# --------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def parse(self, response):
        ...
        for review in response.css(".review"):
            ...
            author_profile_url = review.css(
                " a.a-profile ::attr(href)").extract()
            ...
            review_content = review.css(
                ".review-text-content ::text").extract()
            ...
            image_num = review.css(
                ".review-image-tile-section ::attr(src)").extract()
            item["image_num"] = len(image_num)

            num_of_comments = review.css(
                ".review-comment-total ::text").extract()
